...
$query = "SELECT `userId`, `employeeId`, `firstName`, `middleName`, `lastName`, 
            `phoneNumber`, `emailAddress`, `password`,`designation`, `profilePicture`,
            `status` FROM `employee` WHERE `userId` = ?";
            ...
            <div class="main-content">
                ...
                <form class="profile-form" method="POST" action="./controller/edit-profile.php" enctype="multipart/form-data">
                    <div class="form-section">
                        ...
                        <input type="text" id="emailAddress" name="emailAddress" value="<?php echo htmlspecialchars($user['emailAddress']); ?>"  required>
                    </div>
