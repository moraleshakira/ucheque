    ...
    if ($file['error'] == 0) {
        ...
        if (move_uploaded_file($file['tmp_name'], $filePath)) {
            try {
                ...
                // Check if required data exists in HEADER
                // ==================================================================
                ...
                // Extract month/year target cell
                // ==================================================================
                ...
                // searching for the first Monday in a week
                // ======================================================
                foreach ($totals as $index => $total) {
                    ...
                    if ($firstMondayFound) {
                        ...
                        // check if it is excatly one week
                        // ===============================================
