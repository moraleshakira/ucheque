            ...
            <div class="main-content">
                ...
                <form class="profile-form" method="POST" action="./controller/edit-profile.php" enctype="multipart/form-data">
                    <div class="form-section">
                        ...
                        <input type="text" id="firstName" name="firstName" value="<?php echo htmlspecialchars($user['firstName']); ?>" placeholder="First Name"  required>
                        
                        <label for="middleName">Middle Name</label>
                        <input type="text" id="middleName" name="middleName" value="<?php echo htmlspecialchars($user['middleName']); ?>" placeholder="Middle Name">
                        
                        <label for="lastName">Last Name</label>
                        <input type="text" id="lastName" name="lastName" value="<?php echo htmlspecialchars($user['lastName']); ?>" placeholder="Last Name" required>
                        
                        <label for="phoneNumber">Phone Number</label>
                        <input type="text" id="phoneNumber" name="phoneNumber" value="<?php echo htmlspecialchars($user['phoneNumber']); ?>" placeholder="Phone Number">
